    ...
    <div>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.bigSpace}>
          ...
          <p>
          This project is part of UCSD&apos; Spring 2022 COGS 118A Supervised Machine Learning Course. I worked with 4 other members
        ...
        <div className={styles.bigSpace}>
          ...
          <p>
          This project is part of UCSD Diabetes Design Initiative and UCSD Design Lab&apos; Type 1 Diabetic Care Directive&apos; 
